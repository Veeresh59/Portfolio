            ...
            <div className="container">
                ...
                <div className="contact-content">
                    <div className="contact-info">
                        <h3>Let's Connect</h3>
                        <p>
                            I'm always interested in new front-end development opportunities and exciting web projects. 
                            Whether you need a responsive website, React application, or just want to discuss web development, 
                        ...
                        <div className="contact-details">
                            ...
                            <div className="contact-item">
                                ...
                                <div>
                                    ...
                                    <span>Front-End Internships, Web Development Projects, React Development</span>
                                </div>
                            </div>
                        </div>
