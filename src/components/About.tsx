            ...
            <div className="container">
                ...
                <div className="about-content">
                    <div className="about-text">
                        ...
                        <p>
                            Through my coursework, I've developed expertise in programming fundamentals, data structures, 
                            algorithms, and modern web technologies. I'm passionate about applying my theoretical knowledge 
                            to practical software development projects.
                        </p>
